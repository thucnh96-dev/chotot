    ...
    <div class="wapper">
      ...
      <div class="form__upload--image text-dark">
        ...
        <div id="alert--err" class="alert alert-danger" style="display: none;">
          ...
          <form action="/them-san-pham/?_csrf=" method="POST" enctype="multipart/form-data">
            ...
            <div class="form__info--product">
              ...
              <div class="form-horizontal text-dark">
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="Product_Name" minlength="1" maxlength="120" placeholder="Tên sản phẩm" name="Product_Name" required>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    ...
                    <textarea type="text" class="form-control" id="Description" rows="7" minlength="1" maxlength="3000" placeholder="Mô tả sản phẩm" name="Description" required></textarea>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <select class="form-control" id="Product_Type" name="Product_Type" onchange="typle(this.options[this.selectedIndex].value)" required>
              ...
              <a href="#" data-price="tooltip" data-placement="top" title="Vui lòng đăng sản phẩm với mức giá bạn sẵn lòng bán. Việc thiết lập mức giá có thể ảnh hưởng đến sản phẩm.">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text"  class="form-control" id="Brand" maxlength="200" placeholder="Thương hiệu" name="Brand">
                  </div>
                </div>
                <div class="form-group">
