    ...
    <div class="wapper">
      ...
      <div class="form__upload--image text-dark">
        ...
        <div id="alert--err" class="alert alert-danger" style="display: none;">
          ...
          <form:form action="/post/new/upload" modelAttribute="post"  method="POST" enctype="multipart/form-data">
            ...
            <div class="dropzone">
              <div class="dz-default dz-message">
                ...
                <input type="file" id="files" name="productImgAdd" onchange="uploadImages()" onclick="hihi()" accept="image/*" multiple/>
              ...
              <div class="form-horizontal text-dark">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                   ...
                   <div class="form-group " id="imgArr">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <form:select path="status" class="form-control" id="status" name="status">
                     ...
                     <div class="form-group">
                  <label class="control-label col-sm-2" for="Product_Type">Dia chi:</label>
                  <div class="col-sm-6">
                  <select>
                    
                      <option label="Dia chi" disabled hidden selected onclick="hihi()"></option>  
                         <c:forEach items="${CITYS}" var="CITY">                                                          
                      <option value="${CITY.id}" selected onclick="showDistrict(${CITY.id})">${CITY.name}</option>   
                      </c:forEach>  
                       </select>                                                            
                  </div>
                   <div class="col-sm-6">
