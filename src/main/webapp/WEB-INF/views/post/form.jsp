...
<body>
  ...
  <div class="container" style="margin-bottom: 25px;box-shadow: 1px 1px 1px;">
    <div class="wapper">
      <div id="danger-duration" class="alert alert-danger" style="position: absolute; top: 0; left: 30%; display: none;">
        <strong>Hình ảnh bị lặp không được chấp nhận cho 1 sản phẩm!</strong>.
      </div>
      <br>
      <div class="form__upload--image text-dark">
        <h2>Thêm hình ảnh sản phẩm</h2>
        <p>
          Kéo để sắp xếp lại hình ảnh của bạn. Mỗi sản phẩm có <b><i class="text-danger">tối đa 6 hình ảnh</i></b>.
        </p>
        <div id="alert--err" class="alert alert-danger" style="display: none;">
          ...
          <form:form action="#" modelAttribute="post" method="POST" enctype="multipart/form-data">
            ...
            <div class="dropzone">
              <div class="dz-default dz-message">
                ...
                <p id="sl-Img"><span>0</span>/<span>6</span></p>
                <input type="file" id="files" name="productImgAdd" onchange="uploadImages()" accept="image/*" multiple/>
            ...
            <div class="form__info--product">
              ...
              <div class="form-horizontal text-dark">
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <form:input type="text" path="title" class="form-control" id="Product_Name" minlength="1" maxlength="120" placeholder="Tên sản phẩm" name="Product_Name" />
                    <div class="text-right"><span id="proName">0</span>/120</div>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    ...
                    <form:textarea type="text" path="description" class="form-control" id="Description" rows="7" minlength="1" maxlength="3000" placeholder="Mô tả sản phẩm" name="Description" />
                    <div class="text-right"><span id="desDetail">0</span>/3000</div>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    ...
                    <form:select class="form-control" path="subCategory.id" id="Product_Type" name="Product_Type" onchange="typle(this.options[this.selectedIndex].value)" >
                ...
                <i class="fa fa-info-circle text-primary" aria-hidden="true"></i>
                  ...
                  <div class="col-sm-4">
                    <div class="input-group">
                      <form:input type="number" path="price" class="form-control" id="Price" placeholder="Giá" min="1" name="Price" />
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <div class="input-group">
                      <form:input type="number" path="quantity" class="form-control" id="Quantity" min="1" placeholder="Số lượng" name="Quantity" />
             ...
             <h2 class="text-dark">Thông tin khác</h2>
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <form:input type="text" path="info"  class="form-control" id="Brand" maxlength="200" placeholder="Thương hiệu" name="Brand"/>
                  </div>
                </div> 
                <div class="form-group">
                ...
                <div class="form-group">
                  <div class="col-sm-offset-6 col-sm-10">
                    <a href="/kenh-nguoi-ban">
                      <input type="button" id="cancel" class="btn btn-default" value='Huỷ'/>
                    </a>
                    <input type="submit" id="save" value="Lưu" class="btn btn-success" data-toggle="collapse" data-target="#await" aria-expanded="true" />
                  </div>
                </div>
              </div>
            </div>
  ...
  <div style="position: fixed; top: 0; left: 0; right: 0; bottom: 0; perspective: 1000px; background-color: #00000085; z-index: 9998;" id="await" class="collapse" title="Đang xử lý ..." ><div style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; transform: scale(.3); background: url(../images/load.gif) center center / contain no-repeat;"></div></div>
